...
public class OrderServiceImpl implements IOrderService {
	...
	public ServerResponse getOrderList() {
		List cartList = cartDao.selectCartByUserId(userId);
		return ServerResponse.createBySuccess(cartList);
	}
	@Override
	public ServerResponse getOrderListByUserId(Integer userId) {
		List cartList = cartDao.selectCartByUserId(userId);
		return ServerResponse.createBySuccess(cartList);
	}
